...
Lists.prototype = {
    ...
    createList: function (clientId, details, callback) {
        ...
        createsend.post('lists/' + clientId, null, details, function (err, listId) {
    ...
    getCustomFields: function (listId, callback) {
        new List(this.createsend, listId).getCustomFields(filter, callback);
    },
    ...
    updateList: function (listId, details, callback) {
        new List(this.createsend, listId).updateList(details, callback);
    },

    updateCustomField: function (listId, key, details, callback) {
        new List(this.createsend, listId).updateCustomField(key.replace(/[/g, '').replace(/]/g, ''), details, callback);
    },
